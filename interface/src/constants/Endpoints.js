...
export const LIST_RECIPES_ENDPOINT = ENDPOINT_ROOT + 'listRecipes';
export const GET_RECIPE_ENDPOINT = ENDPOINT_ROOT + 'getRecipe';
export const SAVE_RECIPE_ENDPOINT = ENDPOINT_ROOT + 'saveRecipe';
export const DELETE_RECIPE_ENDPOINT = ENDPOINT_ROOT + 'deleteRecipe';
export const ACTIVATE_RECIPE_ENDPOINT = ENDPOINT_ROOT + 'activateRecipe';